...
![](/0x1A-application_server/images/app_server.jpeg)
...
- Check out these articles/docs for clues on how to configure `Nginx`: [Understanding Nginx Server and Location Block Selection Algorithms, Understanding Nginx Location Blocks Rewrite Rules, Nginx Reverse Proxy](https://intranet.alxswe.com/rltoken/0xFZ6umndhIH19cSGFnexg).
...
![](/0x1A-application_server/images/task_5.png)
________________________
...
In this example, you can see that my Bash script tells the master Gunicorn renewed all the workers.<br>
